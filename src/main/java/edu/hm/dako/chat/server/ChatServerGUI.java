...
public class ChatServerGUI extends Application implements ChatServerGuiInterface {
  ...
  ObservableList<String> implTypeOptions = FXCollections
      .observableArrayList(SystemConstants.IMPL_TCP_SIMPLE, SystemConstants.IMPL_TCP_ADVANCED);
  ...
  public void start(final Stage stage) throws Exception {
    ...
    pane.setStyle("-fx-background-color: #3a4d66");
  ...
  private void startChatServer(String implType, int serverPort, int sendBufferSize,
    ...
    if (implType.equals(SystemConstants.IMPL_TCP_SIMPLE)) {
      ...
      serverImpl = ImplementationType.TCPAdvancedImplementation; // geaddet
      // f�r
      // guianpasssung
    }
