			...
			protected Void call() throws Exception {
				...
				while (!Thread.currentThread().isInterrupted() && !socket.isClosed()) {
					try {
						...
						System.out.println("AdvancedChatServer wartet auf Verbindungsanfragen von Clients...");
						...
						executorService.submit(
								new AdvancedChatWorkerThreadImpl(connection, clients, counter, serverGuiInterface));
					} catch (Exception e) {
						if (socket.isClosed()) {
